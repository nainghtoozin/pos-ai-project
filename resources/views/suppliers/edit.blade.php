        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="mobile" id="mobile" value="{{ old('mobile', $supplier->mobile) }}"
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="township" id="township" value="{{ old('township', $supplier->township) }}"
                        class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg text-gray-800 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400 focus:outline-none"
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="social_profile" id="social_profile" value="{{ old('social_profile', $supplier->social_profile) }}"
                        class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg text-gray-800 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400 focus:outline-none"
                ...
                <div>
                    ...
                    <input type="number" name="opening_balance" id="opening_balance" value="{{ old('opening_balance', $supplier->opening_balance) }}"
                        min="0" step="0.01"
                        class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg text-gray-800 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400 focus:outline-none"
                        placeholder="0.00">
                </div>
